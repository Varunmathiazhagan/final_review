...
class _OthersPageState extends State<OthersPage> {
  ...
  void _showJDoodleIDE() {
    IdeHelper.showJDoodleIDE(context);
  }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Divider(),
          // Make sure this ListTile is visible and properly styled
          ListTile(
            leading: Icon(MdiIcons.codeTags,
                color: Colors.indigo,
                size: 32), // Changed to a more visible coding icon
            title: Text('Code Compiler',
                style: Theme.of(context).textTheme.titleLarge),
            subtitle:
                Text('Write and run code in various programming languages'),
            onTap: _showJDoodleIDE,
            tileColor: Colors.blue.withOpacity(
                0.05), // Add slight background to make it more visible
          ),
          Divider(),
          ListTile(
            leading:
