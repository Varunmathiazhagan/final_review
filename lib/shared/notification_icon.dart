...
class _NotificationIconState extends State<NotificationIcon> {
  ...
  Future<void> _fetchNotifications() async {
    try {
      print('Fetching notifications for user: ${widget.userId}'); // Debug log
      final notifications =
      ...
      print('Notifications fetched: $_notifications'); // Debug log
    } catch (e) {
  ...
  Future<void> _showNotifications(BuildContext context) async {
    print('Displaying notifications dialog'); // Debug log
    await showDialog(
      context: context,
